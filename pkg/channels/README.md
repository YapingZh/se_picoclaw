...
import (
    "study/picoclaw/pkg/bus"
    "study/picoclaw/pkg/channels"     // Reference parent package
    "study/picoclaw/pkg/config"
    "study/picoclaw/pkg/identity"      // New
    "study/picoclaw/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "study/picoclaw/pkg/channels/telegram"   // Triggers init() registration
    _ "study/picoclaw/pkg/channels/discord"
    _ "study/picoclaw/pkg/channels/your_new_channel"  // New addition
)
```
