...
//
//	-X study/picoclaw/pkg/config.Version=<version>
//	-X study/picoclaw/pkg/config.GitCommit=<commit>
//	-X study/picoclaw/pkg/config.BuildTime=<timestamp>
//	-X study/picoclaw/pkg/config.GoVersion=<go-version>
var (
